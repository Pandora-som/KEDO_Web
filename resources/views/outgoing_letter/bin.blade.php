        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="actions">
                        <div class="actions">
                            <form action="{{ route('outgoing_letter.restore', $outgoingLetter->id) }}" method="post">
                                @csrf
                            ...
                            {{-- <button class="btn btn-light delete_button"><a href="{{ route('outgoing_letter.edit', $outgoingLetter->id) }}"><img src="/img/reset.svg"
                                    alt="edit"></a>
                            </button> --}}
                            <form action="{{ route('outgoing_letter.destroy', $outgoingLetter->id) }}" method="post">
                                @csrf
                                @method('delete')
